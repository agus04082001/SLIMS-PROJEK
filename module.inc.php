...
class module extends simbio
{
    ...
    public function generateSubMenu($str_module = '')
    {
        ...
        //tempat mengubah sidebar
        $_submenu = '';
      
        foreach ($menus as $header => $menu) {
            $_submenu .= '<details class="subMenuHeader subMenuHeader-' . $header . '">';
            $_submenu .= '<summary class="summary-right-arrow"><span>' . strtoupper($header) . '</span></summary>';
